...
<div id="result">
	...
	<div style="width:65%; height: 70px;  margin:0 auto;">
		...
		<div style="width: 30%; height:70px; border:1px solid black; float:left;" onclick="load('admin_administratemembers.all');">
			<br>
		...
		<table align="center" style="border-collapse: collapse;">
			...
			<tr>
				...
				<td><select name='state' size='1'>
						...
						<option value='1'>셀러</option>
						<option value='2'>일반</option>
						<option value='3'>셀러신청</option>
				</select></td>
				<td width=50></td>
				<td>검색설정 :</td>
