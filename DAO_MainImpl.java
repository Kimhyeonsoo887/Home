...
public class DAO_MainImpl implements DAO_Main {
	...
	// 패스워드 체크
	@Override
	public String pwdCheck(String member_id) {
		return sqlSession.selectOne("spring.mvc.bridge.persistence.DAO_Main.pwdCheck", member_id);

	}

	// 회원정보 가져오기
	@Override
	public VO_Member readMember(String member_id) {
		return sqlSession.selectOne("spring.mvc.bridge.persistence.DAO_Main.readMember", member_id);
