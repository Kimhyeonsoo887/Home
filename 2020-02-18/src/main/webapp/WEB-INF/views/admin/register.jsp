          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user">
                ...
                <a href="login.all" class="btn btn-primary btn-user btn-block">
                  Register Account
                </a>
                <hr>
                <a href="admin-index.all" class="btn btn-google btn-user btn-block">
                  <i class="fab fa-google fa-fw"></i> Register with Google
                </a>
                <a href="admin-index.all" class="btn btn-facebook btn-user btn-block">
                  <i class="fab fa-facebook-f fa-fw"></i> Register with Facebook
                </a>
              </form>
              <hr>
              <div class="text-center">
                <a class="small" href="forgot-password.all">Forgot Password?</a>
              </div>
              <div class="text-center">
                <a class="small" href="login.all">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
