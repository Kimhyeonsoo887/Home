...
<head>
	...
	<link rel="stylesheet" href="${bootstraps}/login/css/style.css" type="text/css" media="all" />
	<!-- Style-CSS -->
	<!-- <link href="css/font-awesome.min.css" rel="stylesheet"> -->
	<link href="${bootstraps}/login/fonts/font-awesome.min.css" rel="stylesheet">
...
<c:if test="${checkCnt == 0}">
	...
	<div class="main-bg">
		<!-- title -->
		<h1><img src="${resources}/images/logo.png" width="14%"></h1>
		<!-- //title -->
		<div class="sub-main-w3">
			...
			<div class="vertical-tab">
				<div id="section1" class="section-w3ls">
					...
					<article>
						<form action="loginPro.cust" method="post">
							...
							<a href="index.all" class="bottom-text-w3ls">홈으로</a>
				...
				<div id="section2" class="section-w3ls">
					...
					<article>
						<form action="signup_pro.all" method="post">
							<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
				...
				<div id="section3" class="section-w3ls">
					...
					<article>
						<form action="find_account.all" method="post">
							<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
						...
						<form action="change_password.all" method="post">
							<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
