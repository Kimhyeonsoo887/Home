...
import spring.mvc.bridge.service.Service_Host;
...
private static final Logger logger = LoggerFactory.getLogger(Controller_Main.class);
	...
	//---------------------------------김현수 2020-02-20 
		...
		public String saleMain() {
			logger.info("saleMain");
			
			
			
			return "seller/saleMain";
		}
	...
	@RequestMapping("/hoLogin")
	public String hoLogin() {
...
//	====================================================유기복           
	//회원상태 승인관리
	@RequestMapping("/memberAdmin.all")    
