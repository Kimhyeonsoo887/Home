			...
			<div class="join_cont">
				...
				<table class="tbl_type1 type2">
					...
					<tbody>
						...
						<tr style="display:">
							<th scope="row" rowspan="2"><label for="pws">이메일</label></th>
							<td>
								<input type="email" class="inp_txt" name="textphone" title="변경할 전화번호" placeholder="변경할 이메일" style="width:250px" value="">
							</td>
						</tr>
						...
						<tr style="display:">
							...
							<td>
								<input type="text" class="inp_txt" name="textphone" title="변경할 전화번호" placeholder="변경할 전화번호" style="width:250px" value="">
							</td>
						</tr>
