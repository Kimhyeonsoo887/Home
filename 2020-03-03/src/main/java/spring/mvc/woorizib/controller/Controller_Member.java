...
private static final Logger logger = LoggerFactory.getLogger(Controller_Member.class);
	...
	// 전영현 2020.02.23
		...
		//김현수 2020-03-05 매물검색
		@RequestMapping("selectHouse.mem")
		public String selectHouse(HttpServletRequest req, Model model) {
			logger.info("selectHouse.mem");
			
			serviceMember.selectProperty(req, model);
			
			return "member/selectHouse";
		}
		
		@RequestMapping("houseDetail.mem")
		public String houseDetail(HttpServletRequest req, Model model) {
			
			logger.info("houseDetail");
			
			serviceMember.selectPropertyDetail(req, model);
			return "member/houseDetail";
		}
		//김현수 2020-03-05 매물검색
}
